  ...
  >
    <div class="absolute hidden md:block -bottom-32 -left-32 w-96 h-96">
      ...
      >
        ...
        <p>Need Something ?</p>
        <a href="https://m.me/PsionicPlasma/" class="underline"> Let's talk </a>
      </div>
      <svg
        viewBox="0 0 200 200"
    ...
    <header class="z-30 flex items-center w-full h-24 sm:h-32">
      <div class="container flex items-center justify-between px-6 mx-auto">
        ...
        >
          ...
          <span class="mt-1 ml-3 text-xs"> THAIMEO0210@GMAIL.COM </span>
        </div>
        <div class="flex items-center">
          ...
          >
            <a
              ...
              class="flex px-6 py-2 hover:text-black"
            >
              About
            </a>
          </nav>
    ...
    <div class="relative z-20 flex items-center">
      ...
      >
        <div class="flex flex-col">
          <img src="../../public/logo.png" class="mx-auto rounded-full w-28" />
          ...
          <!-- <div class="flex items-center justify-center mt-4">
            <a
              href="#"
              class="px-4 py-2 my-2 text-gray-800 uppercase bg-transparent border-2 border-gray-800 md:mt-16 dark:text-black dark:bg-white hover:dark:bg-gray-100 dark:text-black hover:bg-gray-800 hover:text-black text-md"
            >
            </a>
          </div> -->
        </div>
